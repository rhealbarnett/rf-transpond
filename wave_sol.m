...
%         
%         rf_ex(1,ii)*(conj(sig(1,1,ii)*rf_ex(1,ii) + sig(1,2,ii)*rf_ey(1,ii) +...
%             sig(1,3,ii)*rf_ez(1,ii)));
%         eyj_dot(1,ii) = rf_ey(1,ii)*(conj(sig(2,1,ii)*rf_ex(1,ii) + sig(2,2,ii)*rf_ey(1,ii) +...
%             sig(2,3,ii)*rf_ez(1,ii)));
%         ezj_dot(1,ii) = rf_ez(1,ii)*(conj(sig(3,1,ii)*rf_ex(1,ii) + sig(3,2,ii)*rf_ey(1,ii) +...
%             sig(3,3,ii)*rf_ez(1,ii)));
    ...
    diss_powx = (1.0/4.0)*real(trapz(ax,exj_dot));
    diss_powy = (1.0/4.0)*real(trapz(ax,eyj_dot));
    diss_powz = (1.0/4.0)*real(trapz(ax,ezj_dot));

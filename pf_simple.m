...
E = ((E.^2));
Ediff = zeros(1,npts);
Ediff(2:npts-1) = (E(3:npts) - E(2:npts-1))/(dx);
Ediff(1) = (E(2) - E(1))/dx;
Ediff(end) = (E(end) - E(end-1))/dx;
...
[t,y] = ode45(@(t,y) vdp1(t,y,e,me,om,Ediff), [0 1], [0 ;0])

function dydt = vdp1(t,y,e,m,om,E)

dydt = [y(2); -(e^2/(4*m^2*om^2))*E];
